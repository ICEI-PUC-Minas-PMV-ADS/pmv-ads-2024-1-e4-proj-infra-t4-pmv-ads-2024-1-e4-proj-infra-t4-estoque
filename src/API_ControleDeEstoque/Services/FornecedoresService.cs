    ...
    public class FornecedoresService
    {
        ...
        public Task CreateFornecedor(Fornecedor fornecedor)
        {
            ...
            if (fornecedorExisteByCnpjCpf == false)
            {
                ...
                throw new Exception("Este CNPJ/CPF j� est� cadastrado no banco de dados, por favor verifique no menu 'FORNECEDORES'.");
        }
      ...
      public async Task<bool> UpdateFornecedor(string id, Fornecedor fornecedor)
{
    ...
    {
        throw new ArgumentException("O _id do fornecedor não pode ser nulo ou vazio.");
    }
